    ...
    extend: {
      ...
      colors: {
        ...
        sacred: {
          ...
          warm: "hsl(var(--sacred-warm))",
          text: "hsl(var(--sacred-text))",
          green: "hsl(var(--sacred-green))",
          "green-light": "hsl(var(--sacred-green-light))",
          earth: "hsl(var(--sacred-earth))",
          bark: "hsl(var(--sacred-bark))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 15px hsl(38 80% 55% / 0.15)" },
          "50%": { boxShadow: "0 0 30px hsl(38 80% 55% / 0.3), 0 0 60px hsl(38 80% 55% / 0.1)" },
        },
      },
      animation: {
